...
function count_aude(tab) {
    let i = 0;
    let res = 0;

    while (i < tab.length) {
        if (tab[i].match(/aude/) != null)
            res++;
        i++;
    }
    return res;
...
function count_first_char_maj(tab) {
    let i = 0;
    let res = 0;

    while (i < tab.length) {
        if (tab[i][1].match(/[A-Z]/) != null)
            res++;
        i++;
    }
    return res;
...
function count_maj(tab) {
    let i = 0;
    let res = 0;

    while (i < tab.length) {
        if (tab[i].match(/[A-Z]/) != null)
            res++;
        i++;
    }
    return res;
...
console.log("dans ce tableau il y a", count_journalist(tab), "journalists");
console.log("dans ce tableau il y a", count_number(tab), "handles qui contiennent un numéro");
console.log("dans ce tableau il y a", count_aude(tab), "handles qui contiennent  la suite de lettre \"aude\" sans majuscule");
console.log("dans ce tableau il y a", count_first_char_maj(tab), "pseudo qui commence par une lettre majuscule");
